              ...
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <form action="../actions/modifierProfile.php" method="post">
                    <div class="row gutters">
                        <h6 class="mb-2 text-primary">Modifier le mot de passe</h6>
                        <div class="form-group">
                            <label type="ancien">Ancien mot de passe</label>
                            <input type="password" class="form-control mb-3 mt-2" id="ancien" name="ancien" placeholder="Ancien mot de passe">
                        </div>
                        <div class="form-group">
                          <label for="nouveau">Nouveau mot de passe</label>
                          <input type="password" class="form-control mb-3 mt-2" id="nouveau" name="nouveau" placeholder="Nouveau mot de passe">
                        </div>
                        <div class="form-group">
                          <label for="confirmer">Confirmer le nouveau mot de passe</label>
                          <input type="password" class="form-control mt-2" id="confirmer" name="confirmer" placeholder="Confirmer le nouveau mot de passe">
                        </div>
                    </div>
                    <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="text-right">
                    <button type="submit" id="submit" name="cancel" class="btn btn-secondary mt-2">Cancel</button>
                    <button type="submit" id="submit" name="modifier-pass" class="btn btn-primary mt-2">Modifier</button>
                  </div>
                </div>
                  </form>
                </div> 

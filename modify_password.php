    ...
    <div class="container">
        ...
        <form method="post" style="max-width:300px;margin:auto">
            <div class="form-outline mb-3 mt-5">
                <label class="form-label" for="form1Example1">Nouveau mot de passe</label>
                <input type="password" class="form-control" name="password"/>
            </div>
            <div class="form-outline mb-3 mt-5">
                <label class="form-label" for="form1Example1">Confirmer le nouveau mot de passe</label>
                <input type="password" class="form-control" name="passwordCF"/>
            </div>
